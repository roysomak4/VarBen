from varben.common.methods import count_coverage
from varben.deal_sv.dealReadsType import deal_type1, deal_type2, deal_type3, deal_type4, deal_type5, deal_type6, \
    deal_type7
from varben.deal_sv.getReadsType import pos_type_classify
